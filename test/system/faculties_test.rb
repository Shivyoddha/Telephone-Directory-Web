...
class FacultiesTest < ApplicationSystemTestCase
  ...
  test "should create faculty" do
    ...
    fill_in "Joining date", with: @faculty.joining_date
    fill_in "Name", with: @faculty.name
    fill_in "Phoneno", with: @faculty.phoneno
    fill_in "Site name", with: @faculty.site_name
    fill_in "Telephone", with: @faculty.telephone
